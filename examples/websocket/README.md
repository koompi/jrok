...
This example demonstrates the WebSocket support introduced in Jrok v2.2.0. It creates a simple Node.js server that handles both HTTP requests and WebSocket connections on the same port.
