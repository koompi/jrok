            ...
            <div className="space-y-3">
              {recentTunnels.length > 0 ? recentTunnels.map((tunnel) => (
                ...
                <div className="text-center py-8 text-muted-foreground">
                  ...
                  <p className="text-sm mt-1">Run <code className="bg-muted px-1.5 py-0.5 rounded">jrok tunnel --port 3000</code> to get started</p>
                </div>
              )}
            </div>
          </CardContent>
              ...
              <div className="relative p-5 rounded-xl border bg-card h-full">
                ...
                <div className="relative">
                  ...
                  <Button 
                    ...
                    size="icon" 
                    className="absolute top-2 right-2 h-6 w-6"
                    onClick={() => copyToClipboard('jrok tunnel --port 3000')}
                  >
                    <Copy className="h-3 w-3" />
                  </Button>
                </div>
