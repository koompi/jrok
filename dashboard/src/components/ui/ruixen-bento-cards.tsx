...
const cardContents = [
  {
    ...
    description:
      "Use your own domain or our subdomains. Automatic SSL certificates included for all your services.",
  },
  {
    title: "Secure by Default",
    description:
      "All traffic is encrypted. API key authentication ensures only authorized access to your services.",
  },
  {
    title: "Lightning Fast",
    description:
      "WebSocket-based tunneling for minimal latency and maximum performance. Experience real-time updates without the lag.",
  },  
  {
    title: "Self-Hostable",
    description:
      "Run on your own infrastructure with our open-source server. Full control over your data and configuration.",
  },
  {
    title: "Team Collaboration",
    description:
      "Create organizations, invite team members, and manage access together.",
  },
]
...
const PlusCard: React.FC<{
  ...
  return (
    ...
    ><a href="https://ruixen.com/?utm_source=21stdev&utm_medium=button&utm_campaign=ruixen_bento_cards" target="_blank" rel="noopener noreferrer">
      <CornerPlusIcons />
      {/* Content */}
