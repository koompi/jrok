  ...
  const plans: Plan[] = [
    {
      ...
      limits: {
        ...
        // Security limits (1x multiplier)
        maxHttpRequestsPerMinute: 60,
        maxHttpRequestsPerHour: 1000,
        maxTcpConnectionsPerTunnel: 10,
        maxTcpConnectionsPerOrg: 50,
    ...
    },
    {
      ...
      limits: {
        ...
        customDomains: true,
        prioritySupport: false,
        // Security limits (5x multiplier)
        maxHttpRequestsPerMinute: 300,
        maxHttpRequestsPerHour: 5000,
        maxTcpConnectionsPerTunnel: 50,
        maxTcpConnectionsPerOrg: 250,
        maxTcpBandwidthMbPerMinute: 50,
      },
      isActive: true,
      createdAt: Date.now(),
    },
    {
      ...
      limits: {
        ...
        // Security limits (20x multiplier)
        maxHttpRequestsPerMinute: 1200,
        maxHttpRequestsPerHour: 20000,
        maxTcpConnectionsPerTunnel: 200,
        maxTcpConnectionsPerOrg: 1000,
        maxTcpBandwidthMbPerMinute: 200,
      },
      isActive: true,
      createdAt: Date.now(),
    },
    {
      ...
      limits: {
        ...
        customDomains: true,
        prioritySupport: true,
        // Security limits (100x multiplier - effectively unlimited)
        maxHttpRequestsPerMinute: 6000,
        maxHttpRequestsPerHour: 100000,
        maxTcpConnectionsPerTunnel: 1000,
        maxTcpConnectionsPerOrg: 5000,
        maxTcpBandwidthMbPerMinute: 1000,
      },
      isActive: true,
      createdAt: Date.now(),
    },
